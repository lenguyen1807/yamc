...
int main()
{
  ...
  nn::SGD optimizer(&model, /*learning_rate=*/0.001f);
  ...
  for (size_t epoch = 1; epoch <= EPOCHS; epoch++) {
    ...
    std::cout << "Epoch: " << epoch << "\n"
              << "Train accuracy: "
              << train_correct / static_cast<float>(train_data.dataset.size())
              << "\n"
              << "Average train loss: "
              << train_loss / static_cast<float>(train_data.dataset.size())
              << "\n";
    ...
    std::cout << "Test accuracy: "
              << test_correct / static_cast<float>(test_data.dataset.size())
              << "\n"
              << "Average test loss: "
